...
Transform::Transform(): matTranslate_(XMMatrixIdentity()), matRotate_(XMMatrixIdentity()), matScale_(XMMatrixIdentity()), position_({0,0,0}), rotate_({ 0,0,0 }), scale_({ 0,0,0 })
{
}
...
void Transform::Calclation()
{
	...
	matRotate_ = rotateZ * rotateY * rotateX;
